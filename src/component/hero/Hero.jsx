            ...
            <div className="relative mx-auto max-w-screen-xl px-4 pt-16 pb-36 md:py-32">
                <div className="max-w-5xl mx-auto flex flex-col justify-center items-center">
                    ...
                    <p className="text-gray-200 text-center text-base px-4 md:text-xl">
                        Journey to the Heart of Kashmir, Adventure Awaits with
                        Mount Eco
                    </p>
                    <div className="mt-8 flex flex-col text-center gap-4">
                        <a
                            href="#tour-package"
                            className="block w-full rounded-xl bg-blue-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-blue-500 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
                        >
                            Book Now
                        </a>
                        ...
                        <a
                            href="#tour-package"
                            className="block w-full rounded-xl bg-white px-12 py-3 text-sm font-medium text-blue-600 shadow hover:text-blue-500 focus:outline-none focus:ring active:text-blue-500 sm:w-auto"
                        >
                            View Tour Packages
                        </a>
                    </div>
